    ...
    partial class Z80Processor
    {
        ...
        private Instruction[] InitInstructionSet()
        {
            return new Instruction[]
            {
                ...
                new Instruction("RLCA", 0, 1, (n) => RegA = RotateLeftWithCarry(RegA)),
                ...
                new Instruction("RRCA", 0, 1, (n) => RegA = RotateRightWithCarry(RegA)),
                ...
                new Instruction("DEC D", 0, 1, (n) => RegB = Dec(RegD)),
                new Instruction("LD D, {0:X2}", 1, 2, (n) => RegD = (byte)n),
                new Instruction("RLA", 0, 1, (n) => RegA = RotateLeft(RegA)),
                ...
                new Instruction("RRA", 0, 1, (n) => RegA = RotateRight(RegA)),
                ...
                new Instruction("JR Z, {0:X2}", 1, 2, (n) => JumpRelative((byte)n)),
