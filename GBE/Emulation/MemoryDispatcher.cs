...
namespace GBE.Emulation
{
    class MemoryDispatcher
    {
        ...
        public byte PortsReg; // Ports P10 ~ P15 register (FF00)
        public byte SerialTxReg; // Serial communications register
        public byte SerialControlReg;
        public InterruptFlags IFlagsReg; // Interrupts register
        public InterruptFlags IEnableReg;
        ...
        public byte this[int address]
        {
            get
            {
                ...
                if (address >= 0xF000)
                {
                    ...
                    {
                        return address < 0xFEA0 ? gu[address] : (byte)0;
                    }
